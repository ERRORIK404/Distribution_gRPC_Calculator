...
const (
	OrchestratorService_GetTask_FullMethodName    = "/orchestrator_server.OrchestratorService/GetTask"
	OrchestratorService_SendResult_FullMethodName = "/orchestrator_server.OrchestratorService/SendResult"
)
...
type OrchestratorServiceClient interface {
	GetTask(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*ServerResponse, error)
...
func (c *orchestratorServiceClient) GetTask(ctx context.Context, in *EmptyMessage, opts ...grpc.CallOption) (*ServerResponse, error) {
...
type OrchestratorServiceServer interface {
	GetTask(context.Context, *EmptyMessage) (*ServerResponse, error)
...
func (UnimplementedOrchestratorServiceServer) GetTask(context.Context, *EmptyMessage) (*ServerResponse, error) {
...
func _OrchestratorService_GetTask_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrchestratorServiceServer).GetTask(ctx, req.(*EmptyMessage))
	}
...
var OrchestratorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "orchestrator_server.OrchestratorService",
	...
	Metadata: "pkg/proto/OrchestratorServer.proto",
}
